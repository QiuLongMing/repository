...
public class QueryDeviceHistoryData {
    ...
    public static void main(String args[]) throws Exception {
        ...
        String deviceId = "4f478b29-0e65-4342-8469-3d78f7a03449";
        String gatewayId = "4f478b29-0e65-4342-8469-3d78f7a03449";
        ...
        paramQueryDeviceHistoryData.put("pageNo", pageNo.toString());
        paramQueryDeviceHistoryData.put("pageSize", pageSize.toString());
